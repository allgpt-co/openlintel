...
export function shell(page, content) {
  ...
  if (isResource) {
    ...
    schema.push({
      ...
      ...(page.kind === 'guide'
        ? {
            author: { '@type': 'Organization', name: 'OpenLintel', url: absolute('open-source/') },
            publisher: { '@type': 'Organization', name: 'OpenLintel', url: absolute() },
